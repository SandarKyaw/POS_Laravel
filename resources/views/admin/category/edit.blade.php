                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('category#update') }}" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    <input name="categoryId" type="hidden" value="{{$category->id}}"></input>
                                    <label class="control-label mb-1">Name</label>
                                    <input name="categoryName" type="text"
                                        class="form-control @error('categoryName') is-invalid

                                @enderror"
                                        aria-required="true" aria-invalid="false" value="{{old('categoryName',$category->name)}}" placeholder="Seafood...">
                                    @error('categoryName')
